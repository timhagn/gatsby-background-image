...
**[Testing explained](https://github.com/timhagn/gatsby-background-image/tree/master/packages/gatsby-background-image#testing-gatsby-background-image) in its own section.**
**[Art-Direction support](https://github.com/timhagn/gatsby-background-image/tree/master/packages/gatsby-background-image#how-to-use-with-art-direction-support) built in.**
...
**plus** being able to style with [Tailwind CSS and suchlike Frameworks](https://github.com/timhagn/gatsby-background-image/tree/master/packages/gatsby-background-image#tailwind-css-and-suchlike-frameworks)
